...
%\cleardoublepage%
  ...
  \begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/sdu}
  \end{figure}

  \hei\myfont{\textbf{ 毕业论文(设计)\\}}
  \vspace{40pt}
  \hei\xiaoer{\textbf{论文题目:~\LaTeX~模板操作说明书\\}}
  \vspace{20.5pt}
  \hei\xiaoer{\textbf{ ~\LaTeX~ Templates Operating Instructions\\}}
  \vspace{10.5pt}
  \vspace{55pt}
...
\chapter*{\centering\sanhao\song\bfseries 摘\qquad 要}
\song\defaultfont
\@cabstract
\vspace{\baselineskip}
